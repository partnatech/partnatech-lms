  ...
  return (
    <div className="max-w-sm border border-primary-border rounded-lg overflow-hidden">
      <div className="w-full aspect-[4/3] bg-white">
        <img
          src={`${process.env.STRAPI_BASE_URL}${props.imageUrl.data.attributes.url}`}
          alt="Cover Image"
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center gap-2">
          <p className="text-lg font-semibold text-secondary dark:text-secondary-dark">
            Rp. {discountPrice?.toLocaleString() || price.toLocaleString()}
          </p>
          {discountPrice && (
            <p className="text-sm text-secondary-content dark:text-secondary-content-dark line-through">
        ...
        <div className="flex gap-2 justify-center items-center">
          ...
          <p className="text-sm text-secondary-content dark:text-secondary-content">
            <span className="font-medium uppercase text-primary-content dark:text-primary-content-dark">
              156k
            </span>{" "}
            learners enrolled this Bootcamp
          </p>
        </div>
      </div>
    </div>
